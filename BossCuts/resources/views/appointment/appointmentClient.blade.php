...
<div class="container py-3">
    ...
    <div class="text-center">
        <h1 class="display-4">Appointments CLIENT</h1>
    </div>

    <form class="form-horizontal form-bordered" action="/appointment/client" method="post">
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <input type="hidden" name="_tokenSession" value="{{ Session::token() }}">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <label class="form-control">{{ $user->name . " " . $user->surname }}</label>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <select id="appointmentTimeToBook" class="custom-select custom-select-lg mb-3 cursor-Pointer">
