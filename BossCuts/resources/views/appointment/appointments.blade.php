    ...
    <form class="form-horizontal form-bordered" action="/appointment/client" method="post">
        ...
        <div class="form-group" style="margin-bottom: 0; padding-bottom: 0;">
            <div class="col-sm-12">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <a id="btnFindBarbersFromStyle" class="btn btn-warning btn-lg btn-block" style="margin-top: 30px;" role="button">Find a Barber</a>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <label class="form-control">James Bond</label>                        
                        </div>
                        <div class="col-sm-4">
                            <label class="label-form">Email</label>
                            <label class="form-control">james007@mi6.gov.uk</label>
                        </div>
                        <div class="col-sm-4">
                            <label class="label-form">Phone</label>
                            <label class="form-control">02102650104</label>
                        </div>
                    </div>
                </div>
            </div>
